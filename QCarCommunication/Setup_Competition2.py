...
#car2.spawn_id_degrees(actorNumber=0, location=[2.05+ x_offset, -2+ y_offset, 0.005], rotation=[0, 0, 90], scale=[.1, .1, .1], configuration=0, waitForConfirmation=True)
...
camera2.spawn_degrees (location = [x_offset,  y_offset, 3.938], rotation=[0, 90, 90])
